...
namespace JCsTools.JCQ.IcqInterface.Interfaces
{
  ...
  {
    Core.Interfaces.IReadOnlyNotifyingCollection<Interfaces.IContact> VisibleList { get; }
    Core.Interfaces.IReadOnlyNotifyingCollection<Interfaces.IContact> InvisibleList { get; }
    Core.Interfaces.IReadOnlyNotifyingCollection<Interfaces.IContact> IgnoreList { get; }
