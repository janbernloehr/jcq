...
{
  public class RequestShortUserInfoTask : Core.BasicAsyncTask
  {
    protected override void PerformOperation()
    {
      object svShortUserInfo = ApplicationService.Current.Context.GetService<IcqInterface.Interfaces.IUserInformationService>();
