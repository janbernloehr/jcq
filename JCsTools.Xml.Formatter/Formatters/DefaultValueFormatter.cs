...
namespace JCsTools.Xml.Formatter
{
  public class XmlValueFormatter : IValueFormatter
  {
    ...
    public string IValueFormatter.Serialize(object graph)
    {
    ...
    public object IValueFormatter.Deserialize(string value)
    {
      switch (_ValueTypeCode) {
        case TypeCode.Boolean:
    ...
    public System.Type IValueFormatter.ValueType {
