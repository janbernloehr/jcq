// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OfflineTextMessageViewModelFormatter.cs" company="Jan-Cornelius Molnar">
...
{
    public class OfflineTextMessageViewModelFormatter : DefaultReferenceFormatter
    {
        public OfflineTextMessageViewModelFormatter(ISerializer parent)
            : base(parent, typeof (OfflineTextMessageViewModel), false, false)
        {
        }
        ...
        protected override object CreateObject(Type type, XmlReader reader)
        {
            ...
            dateSent = XmlConvert.ToDateTime(reader.GetAttribute("sent"), XmlDateTimeSerializationMode.Utc);
            ...
            return new OfflineTextMessageViewModel(dateCreated, sender, recipient, message, dateSent,
                MessageColors.HistoryColor);
        }
        ...
        {
            var entity = (OfflineTextMessageViewModel) graph;

            writer.WriteAttributeString("created",
                XmlConvert.ToString(entity.DateCreated, XmlDateTimeSerializationMode.Utc));
            writer.WriteAttributeString("sent", XmlConvert.ToString(entity.DateSent, XmlDateTimeSerializationMode.Utc));
