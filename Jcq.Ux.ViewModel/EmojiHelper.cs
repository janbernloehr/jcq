...
namespace Jcq.Ux.ViewModel
{
    public static class EmojiHelper
    {
        static EmojiHelper()
        {
            EmojiMappings = new Dictionary<string, string>
            {
                {":flag_zw:", "1f1ff-1f1fc"},
                {":zw:", "1f1ff-1f1fc"},
                {":flag_zm:", "1f1ff-1f1f2"},
            ...
            EmojiToUnicodeMappings = new Dictionary<string, string>
            {
                {"2049", "\u2049"},
                {"2122", "\u2122"},
                {"2139", "\u2139"},
            ...
            var keys = EmojiMappings.Keys.Select(k => escapeAllChars(k)).ToArray();

            string pattern = string.Format(@"({0})", string.Join("|", keys));

            EmojiRegex = new Regex(pattern, RegexOptions.Compiled);
        }

        public static Dictionary<string, string> EmojiMappings { get; }

        public static Dictionary<string, string> EmojiToUnicodeMappings { get; }

        public static Regex EmojiRegex { get; }
