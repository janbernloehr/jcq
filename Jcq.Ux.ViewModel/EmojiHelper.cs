...
namespace Jcq.Ux.ViewModel
{
    ...
    {
        private static readonly Dictionary<string, string> _emojiMappings;
        private static readonly Dictionary<string, string> _emojiToUnicodeMappings;
        private static readonly Regex _emojiRegex;

        public static Dictionary<string, string> EmojiMappings { get { return _emojiMappings; } }

        public static Dictionary<string, string> EmojiToUnicodeMappings { get { return _emojiToUnicodeMappings; } }

        public static Regex EmojiRegex { get { return _emojiRegex; } }


        static EmojiHelper()
        {
            _emojiMappings = new Dictionary<string, string>
            {
                {":flag_zw:", "1f1ff-1f1fc"},
                {":zw:", "1f1ff-1f1fc"},
                {":flag_zm:", "1f1ff-1f1f2"},
            ...
            _emojiToUnicodeMappings = new Dictionary<string, string>() {
                {"2049", "\u2049"},
{"2122", "\u2122"},
{"2139", "\u2139"},
{"2194", "\u2194"},
...
{"1F44F", "\uD83D\uDC4F"},
{"1F64C", "\uD83D\uDE4C"},
{"1F468-2764-1F48B-1F468", "\uD83D\uDC68\u200D\u2764\uFE0F\u200D\uD83D\uDC8B\u200D\uD83D\uDC68"},
{"1F469-2764-1F48B-1F469", "\uD83D\uDC69\u200D\u2764\uFE0F\u200D\uD83D\uDC8B\u200D\uD83D\uDC69"},
{"1F48F", "\uD83D\uDC8F"},
{"1F468-2764-1F468", "\uD83D\uDC68\u200D\u2764\uFE0F\u200D\uD83D\uDC68"},
{"1F469-2764-1F469", "\uD83D\uDC69\u200D\u2764\uFE0F\u200D\uD83D\uDC69"},
{"1F491", "\uD83D\uDC91"},
...
{"1F600", "\uD83D\uDE00"}
            ...
            Func<string, string> escapeAllChars = (a) =>
            {
                var t = new StringBuilder(a);

                foreach (var c in escapeChars)
                {

                    t.Replace(new string(new[] { c }), new string(new[] { '[', c, ']' }));

                }

                t.Replace(new string(new[] { '\\' }), new string(new[] { '\\', '\\' }));

                return t.ToString();
            };

            var keys = _emojiMappings.Keys.Select(k => escapeAllChars(k)).ToArray();

            var pattern = string.Format(@"({0})", string.Join("|", keys));

            _emojiRegex = new Regex(pattern, RegexOptions.Compiled);
        }

        public static void Initialize()
        {
            // does nothing, just here to allow initializing this static class.
        }
    }
}