// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ListOfBytesFormatter.cs" company="Jan-Cornelius Molnar">
...
{
    public class ListOfByteFormatter : DefaultReferenceFormatter
    {
        public ListOfByteFormatter(ISerializer parent) : base(parent, typeof (List<byte>))
        {
        }
