// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PropertyDescriptor.cs" company="Jan-Cornelius Molnar">
...
namespace JCsTools.Xml.Formatter
{
    public class PropertyDescriptor
    {
        ...
        {
            _Info = info;
            IsValueType = info.PropertyType.IsValueType;
            IsString = ReferenceEquals(info.PropertyType, typeof (string));
            IsIListDescendant = PropertyType.GetInterface(typeof (IList).ToString()) != null;
        }
        ...
        {
            get { return !IsValueType & !IsString; }
        }
        ...
        /// </summary>
        public bool IsIListDescendant { get; private set; }
